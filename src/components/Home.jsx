  ...
  return (
    ...
    >
      ...
      <p className="home__info">
        I&apos;m a passionate frontend software engineer, crafting captivating
        user experiences one line of code at a time. With a blend of creativity
        and technical expertise, I strive to bring life to pixels, transforming
